...
import "./BizflipArtTradable.sol";

contract BizflipArtFactory is Ownable {
    ...
    */
    ...
    /// @notice Method for deploy new BizflipArtTradable contract
        ...
        returns (address)
    {
        ...
        BizflipArtTradable nft = new BizflipArtTradable(
            _name,
            _symbol,
            mintFee,
            feeRecipient,
