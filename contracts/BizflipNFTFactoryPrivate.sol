...
import "./BizflipNFTTradablePrivate.sol";

contract BizflipNFTFactoryPrivate is Ownable {
    /// @dev Events of the contract
    event ContractCreated(address indexed creator, address indexed nft);
    event ContractDisabled(address indexed caller, address indexed nft);

    /// @notice Bizflip auction contract address
    ...
    */
    ...
    @dev Only admin
    @param _mintFee uint256 the mint fee to set
    */
    ...
    */
    ...
    /// @notice Method for deploying a new BizflipNFTTradablePrivate contract
        ...
        returns (address)
    {
        ...
        BizflipNFTTradablePrivate nft = new BizflipNFTTradablePrivate(
            _name,
            _symbol,
            auction,
            marketplace,
    ...
    /// @notice Method for registering an existing BizflipNFTTradablePrivate contract
    ...
    /// @notice Method for disabling an existing BizflipNFTTradablePrivate contract
    /// @param  tokenContractAddress Address of NFT contract
