...
import "./BizflipNFTTradable.sol";

contract BizflipNFTFactory is Ownable {
    ...
    */
    ...
    /// @notice Method for deploy new BizflipNFTTradable contract
        ...
        returns (address)
    {
        ...
        BizflipNFTTradable nft = new BizflipNFTTradable(
            _name,
            _symbol,
            auction,
            marketplace,
            ...
            mintFee,
            feeRecipient,
            msg.sender  // Pass the initial owner
        );
    ...
    /// @notice Method for registering existing BizflipNFTTradable contract
    ...
    /// @notice Method for disabling existing BizflipNFTTradable contract
    /// @param  tokenContractAddress Address of NFT contract
